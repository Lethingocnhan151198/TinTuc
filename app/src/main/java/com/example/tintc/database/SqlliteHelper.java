...
public class SqlliteHelper {
    ...
    private String CREATE_NEWS_TABLE = "CREATE TABLE " +TABLE_NEWS + "(" + COLUMN_NEWS_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + COLUMN_NEWS_TITLE +" TEXT," +COLUMN_NEWS_IMAGE + " TEXT," + C
